...
function addLine() {
  ...
  var panel = document.getElementById('linePanel');
  ...
  lineSelector.id = "O" + index.toString();
  lineSelector.setAttribute('onchange', 'changeOrientation(this)');
  ...
  orientBox.appendChild(lineSelector);
